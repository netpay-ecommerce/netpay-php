...
use \NetPay\Handlers\DeleteTokenCardDataHandler;

class DeleteTokenCard
{
    /**
    ...
    {
        $fields = DeleteTokenCardDataHandler::prepare($input);

        $fields_string = json_encode($fields);

        $curl_result = Curl::post(Config::$DELETE_TOKEN_CARD, $fields_string, $jwt);
