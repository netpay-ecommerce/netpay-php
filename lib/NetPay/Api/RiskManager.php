...
use \NetPay\Handlers\RiskManagerDataHandler;
...
class RiskManager
{
     ...
     */
    public static function post($jwt, array $input, $merchanDefinedDataList)
    {
        $fields = RiskManagerDataHandler::prepare($input, $merchanDefinedDataList);

        $fields_string = json_encode($fields);

        $curl_result = Curl::post(Config::RISK_MANAGER, $fields_string, $jwt);
